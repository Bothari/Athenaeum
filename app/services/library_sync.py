...
# Hardcover API client (rate limits, pacing, 429 handling) lives in hardcover.py
# so interactive search can share it. Re-exported here for existing callers.
from .hardcover import (  # noqa: E402
    HC_API_URL,
    HC_DAILY_RESERVE,
    HC_MAX_THROTTLE_RETRIES,
    HC_MIN_REQUEST_INTERVAL,
    HC_SHORT_WAIT_MAX,
